...
\graphicspath{{image/}} % изображения находятся в папке image
...
\begin{figure}[H]
  ...
  \caption{Простая вставка изображения}
  \label{fig:simple}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.3\textwidth, angle=45]{01}
...
\begin{itemize}
  ...
  \item размещение нескольких изображений рядом с помощью \texttt{minipage} и \texttt{subfigure};
